...
public class HaversineDistanceService implements DistanceService {
    ...
    @Override
    public BigDecimal calculateDistanceKm(Double sourceLatitude, Double sourceLongitude, Double destinationLatitude,
    ...
    private void validateCoordinates(Double sourceLatitude, Double sourceLongitude, Double destinationLatitude,
                                     Double destinationLongitude) {
        ...
        if (sourceLatitude < -90 || sourceLatitude > 90 || destinationLatitude < -90 || destinationLatitude > 90) {
            throw new IllegalArgumentException("Latitude must be between -90 and 90");
        }
        if (sourceLongitude < -180 || sourceLongitude > 180 || destinationLongitude < -180 || destinationLongitude > 180) {
